...
<section class="content-body">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= $power_admin('master/skpd') ?>"><i class="zmdi zmdi-memory"></i> Master</a></li>
        <li class="breadcrumb-item"><a href="<?= $power_admin('master/skpd') ?>">SKPD</a></li>
        <li class="breadcrumb-item active"><?= ucwords(str_replace('-',' ', $p)) ?></li>
    </ol>
    <div class="row">
        <div class="col-12">
            <div class="card card-body" id="<?= $p ?>">
                <div class="h6 font-bold">
                    <span>Master SKPD <?= ucwords(str_replace('-',' ', $p)).' "'.substr(@$skpd[$q],9).'"' ?></span>
                </div>
                <hr class="my-1">
<?php if ( is_numeric($q) ) { ?>
                <form method="POST" id="add">
                    <div class="collapse">
                        <div class="form-group md" style="width: 50%">
                            ...
                            <?= form_dropdown('id_skpd', $skpd, $q, 'class="form-control md disabled"') ?>
                            <i class="form-bar"></i>
                        </div>
                        <div class="form-group md" style="width: 50%">
