...
<section class="content-body">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?= strtoupper($func_path2title($p)) ?></li>
    </ol>
    <div class="row">
        <div class="col-12">
            <div class="card card-body" id="<?= $p ?>">
                <div class="h6 font-bold">
                    <span>Master <?= strtoupper($func_path2title($p)) ?></span>
                </div>
                <hr class="my-1">
<?php if ($q == NULL) { ?>
                <form method="POST" id="add">
                    <div class="collapse">
                        <div class="form-group md" style="width: 50%">
                            <label>Kode <?= strtoupper($func_path2title($p)) ?></label>
                            <input type="text" name="code" class="form-control md" data-required>
                            <i class="form-bar"></i>
                        </div>
                        <div class="form-group md">
                            <label>Nama <?= strtoupper($func_path2title($p)) ?></label>
