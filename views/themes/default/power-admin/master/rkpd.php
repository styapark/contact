...
?>
                            <div class="form-group md mb-0 mr-3">
                                <?= form_dropdown('startyear', $years, $year_session, ' class="form-control md" title="Awal Tahun"') ?>
                ...
                <form method="POST" id="<?= $q ?>">
                    <div class="collapse">
                        ...
                        <div class="form-group md">
                            ...
                            <?= form_dropdown('id_bidang', $bidang, NULL, 'class="form-control md" data-required') ?>
                            <i class="form-bar"></i>
                        </div>
                        <div class="form-group md">
                            <label>Nama <?= ucwords($q)?></label>
