...
function actionPrint(value, row, index) {
    return startIcon.concat(iconPrint,endIcon).join('');
}
var actionPrint = startIcon.concat(iconPrint,endIcon).join('');

function actionPrintDelete(value, row, index) {
    return startIcon.concat(iconPrint,iconDelete,endIcon).join('');
}
var actionPrintDelete = startIcon.concat(iconPrint,iconDelete,endIcon).join('');

function actionPrintPDF(value, row, index) {
    return startIcon.concat(iconPrint,iconPDF,endIcon).join('');
}
var actionPrintPDF = startIcon.concat(iconPrint,iconPDF,endIcon).join('');
