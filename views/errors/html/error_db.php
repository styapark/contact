...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="media/images/icon/database.png">
        <style>
    ...
    <body class="container-fluid">
        <div class="card col-sm-11 col-md-9 col-lg-6 mx-auto mb-3 grey-text" style="margin-top: 4rem;">
            <div class="card-body text-center">
                ...
                <img class="img-fluid" style="max-height: 250px; opacity: 0.5" src="media/images/icon/database.png"/>
                <span class="h6-responsive"><?= $message; ?></span>
