 ...
 */
$config['site_title']                 = get_setup('system_title');      // Site Title, example.com
$config['admin_email']                = get_setup('system_mail');       // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = get_setup('system_login_identity');       /* You can use any unique column in your table as identity column.
