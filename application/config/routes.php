...
/* services/v1/master */
$route['services/v1/master/([a-zA-Z0-9\-\_]+)/(:any)/(:any)/(:any)'] = 'services_v1/$1/$2/$3/$4';
$route['services/v1/master/([a-zA-Z0-9\-\_]+)/(:any)/(:any)'] = 'services_v1/$1/$2/$3';
$route['services/v1/master/([a-zA-Z0-9\-\_]+)/(:any)'] = 'services_v1/$1/$2';
$route['services/v1/master/([a-zA-Z0-9\-\_]+)'] = 'services_v1/$1';
/* services/v1/* */
